...
export interface ActivityHeatmapProps<T> {
  items: T[]
...
/**
 * GitHub-style calendar heatmap. Generic over the item type — each item
 * contributes +1 to its day's count via the `date` accessor.
 */
export function ActivityHeatmap<T>({
  items,
  date,
  weekCount = 16,
  className,
