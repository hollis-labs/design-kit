...
/**
 * UI, not transport. Window keydown handling with editable-target and modifier
 * guards is the same category as a focus trap or a roving tabindex. It *pairs*
 * with `design-app-runtime`'s `listCursorNeighbors`, but pairing is not
 * belonging — and filing it as transport would leave that package holding the
 * only DOM-event code it has.
 */
