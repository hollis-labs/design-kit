...
export function FilterCycleToggle<T extends string>({
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded border border-border-subtle bg-panel-2/50 px-2 py-0.5 text-caption uppercase tracking-wider text-text-muted transition-all hover:border-border"
    >
      {active.dotColor && (
